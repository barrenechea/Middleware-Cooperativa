namespace Middleware.Model.API
{
    public class APITabaux10
    {
        ...
        public int orden_patr { get; set; }
        public string estado { get; set; }
        public string giro { get; set; }
        public int tipo_calle { get; set; }
        ...
        public string entre_call { get; set; }
